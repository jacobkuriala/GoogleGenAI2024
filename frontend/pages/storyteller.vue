<template>
  <div
    class="page-story-teller w-full h-full flex justify-center items-center px-16 pt-16 pb-12 gap-x-5"
  >
    <div class="story-teller-ui w-full grid grid-cols-12 gap-5 h-full">
      <GeminiOutput
        :output="output"
        :loading="false"
